...
const questions: Question[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: `<p className=\"text-sm text-[#1E0F62]\">Your Ontario Health Card should look like this.</p>`,
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: `<p className=\"text-sm text-[#1E0F62]\">In this example, Rita the Rat and Rachel the Rabbit are both applying for the TDP. They are applying in February.</p>\n`,
        images: ["/images/id11-1.jpg"],
        content_orientation: "vertical",
      },
      {
        text: `<p className=\"text-sm text-[#1E0F62]\">Rita the Rat already celebrated her birthday, which was in January. Rachel the Rabbit does not have her birthday until March.</p>`,
        images: ["/images/id11-2.jpg"],
        content_orientation: "vertical",
      },
      {
        text: `<p className=\"text-sm text-[#1E0F62]\"> Since Rita the Rat already celebrated her birthday, she puts down her current age. Rachel the Rabbit has not turned 40 years old yet, but will write it in her application since that is the age she is turning this calendar year.</p>\n<p className=\"text-sm text-[#1E0F62]\">Once you figure out your age for this calendar year, please press the category that your age falls into.</p>\n`,
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: '<p className="text-sm text-[#1E0F62]">Name<br />Enter your full legal first and last name as it appears on official documents (e.g., health card or ID). Select the checkbox if you only go by a single name.<br />Note: Ensure there are no typos, as discrepancies can delay processing.</p>\n',
      ...
      {
        text: '<p className="text-sm text-[#1E0F62]">Date of Birth<br />Enter your date of birth in the format: YYYY-MM-DD.</p>\n',
