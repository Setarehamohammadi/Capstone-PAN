...
const questions: Question[] = [
  {
    ...
    "text": `<p className=\"text-sm text-[#1E0F62]\">This tool is designed to help you understand and navigate the application process for Ontario’s Trillium Drug Program (TDP). The TDP is a government program that provides financial support for prescription drug costs, especially for those with high medication expenses.</p>\n<p className=\"text-sm text-[#1E0F62]\">What this tool offers:</p>\n<ul className=\"list-disc list-inside text-sm text-[#1E0F62]\">\n  <li className=\"text-sm text-[#1E0F62]\">The tool is able to check your eligibility to assess if you meet basic requirements for the TDP.</li>\n  <li className=\"text-sm text-[#1E0F62]\">The navigator tool also offers guidance by breaking down the application process into simple steps, ensuring you know what you do at every stage.</li>\n</ul>\n<p className=\"text-sm text-[#1E0F62]\"><span className=\"font-bold\">Important Note:</span> This is not the official Trillium Drug Program application. This is a tool meant to be used alongside the application process. When you’re ready to apply, you’ll need to visit the official Ontario government website and complete the online official form.</p>\n<p className=\"text-sm text-[#1E0F62]\">By using this Navigator tool, you’re taking a big step toward gaining access to medication coverage. Let’s get started!</p>`,
    "images": [],
  ...
  },
  {
    "id": 3,
    "title": "Disclaimer",
    "text": `<p className=\"text-sm text-[#1E0F62]\">Before using this navigator tool, please review each of the following statements carefully. By proceeding, you acknowledge that you have read, understood, and agreed to all of the statements below. If you fully agree, please press the “I Agree” button to continue.</p>\n<p className=\"text-sm text-[#1E0F62]\"><span className=\"font-bold\">Note:</span> In the following statements, “users” refers to “you,” the user of this tool.</p>\n<ul className=\"list-disc list-inside text-sm text-[#1E0F62]\">\n  <li className=\"text-sm text-[#1E0F62]\">This tool is a guide to assist with the Trillium Drug Program (TDP) application process but is not a replacement for the official application or government resources.</li>\n  <li className=\"text-sm text-[#1E0F62]\">The information provided in this tool is accurate as of January 2025. Users should verify any updates or changes to TDP policies or eligibility criteria.</li>\n  <li className=\"text-sm text-[#1E0F62]\">Using this tool does not guarantee eligibility or approval for the TDP. Final decisions rest with the Ontario government.</li>\n  <li className=\"text-sm text-[#1E0F62]\">This navigator tool does not require users to input health-related or personal information. Users are strongly advised to only share sensitive information on websites verified as being directly offered by the government of Ontario.</li>\n  <li className=\"text-sm text-[#1E0F62]\">Users are responsible for reviewing and understanding the TDP guidelines on the official Ontario government website.</li>\n  <li className=\"text-sm text-[#1E0F62]\">The tool’s functionality may depend on device compatibility and internet access. Users are encouraged to share any performance issues or suggestions via the feedback form at the end of the tool.</li>\n  <li className=\"text-sm text-[#1E0F62]\">The use of this tool is entirely voluntary. Users may discontinue use at any time without any implications.</li>\n  <li className=\"text-sm text-[#1E0F62]\">The creators of this tool are not liable for any errors in the TDP application process resulting from reliance on this tool.</li>\n  <li className=\"text-sm text-[#1E0F62]\">This tool is independently created and is not officially affiliated with or endorsed by the Ontario Ministry of Health.</li>\n</ul>`,
    "images": [],
  ...
  },
  {
    ...
    "text": `<p className=\"text-sm text-[#1E0F62]\">Thank you for taking the time to review the statements. Since you have chosen not to agree, you will not be able to use this navigator tool. However, we want to ensure that you have access to resources that may support you in navigating options for PrEP coverage. Below, we have provided a list of helpful resources to guide you:</p>\n<ul className=\"list-disc list-inside text-sm text-[#1E0F62]\">\n  <li className=\"text-sm text-[#1E0F62]\">Ontario Drug Benefit</li>\n  <li className=\"text-sm text-[#1E0F62]\">OHIP+</li>\n  <li className=\"text-sm text-[#1E0F62]\">PrEP Start</li>\n  <li className=\"text-sm text-[#1E0F62]\">Freddie</li>\n</ul>\n<p className=\"text-sm text-[#1E0F62]\">If you would like to revisit the tool and reconsider your decision, you can press the “Restart” button below to return to the start page.</p>`,
    "images": [],
